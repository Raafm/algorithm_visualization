...
[cor_aresta, 9, 6, 98.6154146165801] ,
...
graph = [
    ...
    [(10, 17, 9),  cor_aresta],
    [(8, 12),  cor_aresta],
    [(7, 14, 38, 21),  cor_aresta],
    [(3, 4, 6, 15),  cor_aresta],
    [(6, 11, 18),  cor_aresta],
    [(10, 16),  cor_aresta],
    [(5, 7),  cor_aresta],
    [(19, 22, 16, 26),  cor_aresta],
    [(5, 8),  cor_aresta],
    [(9, 19),  cor_aresta],
    [(11, 13, 22, 23),  cor_aresta],
    [(6, 18),  cor_aresta],
    [(10, 17),  cor_aresta],
    [(13, 20, 21, 15, 22),  cor_aresta],
    [(19, 24),  cor_aresta],
    [(8, 19),  cor_aresta],
    [(13, 16, 19),  cor_aresta],
    [(16, 36),  cor_aresta],
    [(20, 26, 31),  cor_aresta],
    [(38, 30, 31),  cor_aresta],
    [(13, 24, 28, 29),  cor_aresta],
    [(38, 30, 32),  cor_aresta],
    [(26, 34, 36),  cor_aresta],
    [(26, 31),  cor_aresta],
    [(25, 27, 33, 31),  cor_aresta],
    [(24, 25, 29, 30),  cor_aresta],
    [(27),  cor_aresta],
    [(30, 34),  cor_aresta],
    [(28, 33, 35),  cor_aresta],
    [(34, 37, 36),  cor_aresta],
    [(23, 28, 35, 37),  cor_aresta],
    [(35, 36, 39),  cor_aresta],
    [(8, 25, 27), cor_aresta],
    [(37), cor_aresta]
]
...
edge_dict = {
    (0, 1) : (cor_aresta, 80.62257748298549) ,
    (0, 2) : (cor_aresta, 76.15773105863909) ,
    (1, 4) : (cor_aresta, 111.80339887498948) ,
    (2, 3) : (cor_aresta, 81.39410298049853) ,
    (2, 4) : (cor_aresta, 101.9803902718557) ,
    (3, 9) : (cor_aresta, 127.47548783981962) ,
    (4, 5) : (cor_aresta, 122.06555615733703) ,
    (4, 9) : (cor_aresta, 115.0) ,
    (5, 12) : (cor_aresta, 130.0) ,
    (5, 14) : (cor_aresta, 186.07794065928394) ,
    (6, 10) : (cor_aresta, 120.41594578792295) ,
    (6, 17) : (cor_aresta, 92.19544457292886) ,
    (7, 8) : (cor_aresta, 120.83045973594571) ,
    (7, 12) : (cor_aresta, 86.02325267042627) ,
    (8, 14) : (cor_aresta, 172.4093964956667) ,
    (8, 38) : (cor_aresta, 178.88543819998318) ,
    (8, 21) : (cor_aresta, 78.10249675906655) ,
    (9, 6) : (cor_aresta, 98.6154146165801) ,
    (9, 15) : (cor_aresta, 103.07764064044152) ,
    (10, 11) : (cor_aresta, 137.92751719653336) ,
    (10, 18) : (cor_aresta, 102.41581909060729) ,
    (11, 16) : (cor_aresta, 163.22989922192565) ,
    (13, 19) : (cor_aresta, 139.2838827718412) ,
    (13, 22) : (cor_aresta, 148.66068747318505) ,
    (13, 16) : (cor_aresta, 131.52946437965903) ,
    (13, 26) : (cor_aresta, 185.29975715040752) ,
    (38, 25) : (cor_aresta, 100.4987562112089) ,
    (38, 27) : (cor_aresta, 150.0) ,
    (16, 22) : (cor_aresta, 144.22205101855957) ,
    (16, 23) : (cor_aresta, 153.16984037335808) ,
    (17, 18) : (cor_aresta, 143.55835050598762) ,
    (19, 20) : (cor_aresta, 148.07092894960846) ,
    (19, 21) : (cor_aresta, 134.5362404707371) ,
    (19, 15) : (cor_aresta, 100.0) ,
    (19, 22) : (cor_aresta, 100.4987562112089) ,
    (20, 24) : (cor_aresta, 117.15374513859983) ,
    (23, 36) : (cor_aresta, 149.0) ,
    (24, 26) : (cor_aresta, 154.8418548067673) ,
    (24, 31) : (cor_aresta, 202.23748416156684) ,
    (25, 30) : (cor_aresta, 152.34500319997372) ,
    (25, 31) : (cor_aresta, 134.1640786499874) ,
    (26, 28) : (cor_aresta, 110.8873302050329) ,
    (26, 29) : (cor_aresta, 160.11246047700348) ,
    (27, 30) : (cor_aresta, 180.96684779262748) ,
    (27, 32) : (cor_aresta, 233.45235059857504) ,
    (28, 34) : (cor_aresta, 158.11388300841898) ,
    (28, 36) : (cor_aresta, 136.01470508735446) ,
    (29, 31) : (cor_aresta, 107.70329614269009) ,
    (30, 33) : (cor_aresta, 123.81033882515628) ,
    (30, 31) : (cor_aresta, 103.58088626768938) ,
    (33, 34) : (cor_aresta, 130.0) ,
    (34, 35) : (cor_aresta, 138.92443989449805) ,
    (35, 37) : (cor_aresta, 104.40306508910551) ,
    (35, 36) : (cor_aresta, 134.1640786499874) ,
    (36, 37) : (cor_aresta, 222.0360331117452) ,
    (37, 39) : (cor_aresta, 106.28264204469137) 
}